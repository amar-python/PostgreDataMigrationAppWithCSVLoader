# outputs.tf - staging outputs consumed by the staging migration workflow
...
output "container_apps_job_name" {
  ...
  description = "Name of the staging migration job. Trigger with az containerapp job start."
}
